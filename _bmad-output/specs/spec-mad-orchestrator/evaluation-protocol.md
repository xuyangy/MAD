...
**These figures are offline planning estimates matched to the fixed roster and workload, and
they are not forecasts.** `presets.ts` labels them planning figures and nothing reads them
